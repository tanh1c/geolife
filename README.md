...
- GeoLife has no authoritative Home/Office ground truth; evaluation therefore uses sensitivity, abstention/parity checks, plus manual plausibility review on sampled users rather than absolute supervised accuracy. See `docs/evaluation/01_home_office_manual_plausibility.md`.
